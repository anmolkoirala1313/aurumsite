                                    ...
                                    <div class="recent-comment">
                                        ...
                                        <a href="javascript:void(0)" class="dash-card text-dark">
                                            <div class="dash-card-container">
                                                ...
                                                <div class="dash-card-avatars">
                                                    <div class="e-avatar"><img class="img-fluid" src="{{asset('assets/backend/img/profiles/img-9.jpg')}}" alt="Avatar"></div>
                                                </div>
                                            </div>
                                        </a>
                                        <hr>
                                        ...
                                        <a href="javascript:void(0)" class="dash-card text-dark">
                                            <div class="dash-card-container">
                                                ...
                                                <div class="dash-card-avatars">
                                                    <div class="e-avatar"><img class="img-fluid" src="{{asset('assets/backend/img/profiles/img-5.jpg')}}" alt="Avatar"></div>
                                                </div>
                                            </div>
                                        </a>
                                        <hr>
                                        <a href="javascript:void(0)" class="dash-card text-dark">
                                            <div class="dash-card-container">
                                                ...
                                                <div class="dash-card-avatars">
                                                    <div class="e-avatar"><img class="img-fluid" src="{{asset('assets/backend/img/profiles/img-6.jpg')}}" alt="Maria Cotton"></div>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                            ...
                            <div class="card flex-fill team-lead shadow-sm grow">
                                ...
                                <div class="card-body">
                                    <div class="media mb-3">
                                        <div class="e-avatar avatar-online mr-3"><img src="{{asset('assets/backend/img/profiles/img-5.jpg')}}" alt="Maria Cotton" class="img-fluid"></div>
                                    ...
                                    <hr>
                                    <div class="media mb-3">
                                        <div class="e-avatar avatar-online mr-3"><img class="img-fluid" src="{{asset('assets/backend/img/profiles/img-5.jpg')}}" alt="Linda Craver"></div>
                                        <div class="media-body">
                                    ...
                                    <hr>
                                    <div class="media mb-3">
                                        <div class="e-avatar avatar-online mr-3"><img src="{{asset('assets/backend/img/profiles/img-4.jpg')}}" alt="Linda Craver" class="img-fluid"></div>
                                        <div class="media-body">
                                    ...
                                    <hr>
                                    <div class="media mb-3">
                                        <div class="e-avatar avatar-online mr-3"><img class="img-fluid" src="{{asset('assets/backend/img/profiles/img-3.jpg')}}" alt="Linda Craver"></div>
                                        <div class="media-body">
                                    ...
                                    <hr>
                                    <div class="media">
                                        <div class="e-avatar avatar-offline mr-3"><img class="img-fluid" src="{{asset('assets/backend/img/profiles/img-2.jpg')}}" alt="Linda Craver"></div>
                                        <div class="media-body">
                                ...
                                <div class="card-body recent-activ admin-activ">
                                    <div class="recent-comment">
                                        <div class="notice-board">
                                            <div class="table-img">
                                                <div class="e-avatar mr-3"><img class="img-fluid" src="{{asset('assets/backend/img/profiles/img-5.jpg')}}" alt="Danny Ward"></div>
                                            </div>
                                        ...
                                        <div class="notice-board">
                                            <div class="table-img">
                                                <div class="e-avatar mr-3"><img class="img-fluid" src="{{asset('assets/backend/img/profiles/img-2.jpg')}}" alt="John Gibbs"></div>
                                            </div>
                                            <div class="notice-body">
                                        ...
                                        <div class="notice-board">
                                            <div class="table-img">
                                                <div class="e-avatar mr-3"><img class="img-fluid" src="{{asset('assets/backend/img/profiles/img-6.jpg')}}" alt="Maria Cotton"></div>
                                            </div>
                                            <div class="notice-body">
                                                <h6 class="mb-0">Lorem ipsum dolor sit amet, id quo eruditi eloquentiam.</h6>
                                        ...
                                        <div class="notice-board">
                                            <div class="table-img">
                                                <div class="e-avatar mr-3"><img class="img-fluid" src="{{asset('assets/backend/img/profiles/img-4.jpg')}}" alt="Linda Craver"></div>
                                            </div>
                                            <div class="notice-body">
                                                <h6 class="mb-0">Lorem ipsum dolor sit amet, id quo eruditi eloquentiam.</h6>
                                        ...
                                        <div class="notice-board">
                                            <div class="table-img">
                                                <div class="e-avatar mr-3"><img class="img-fluid" src="{{asset('assets/backend/img/profiles/img-3.jpg')}}" alt="Jenni Sims"></div>
                                            </div>
                                            <div class="notice-body">
                                                <h6 class="mb-0">Lorem ipsum dolor sit amet, id quo eruditi eloquentiam.</h6>
