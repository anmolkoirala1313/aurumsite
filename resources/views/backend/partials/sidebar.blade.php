                        ...
                        <div class="card ctm-border-radius shadow-sm border-none grow">
                            <div class="card-body">
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-6 align-items-center shadow-none text-center">
                                        <a href="{{route('blogcategory.index')}}" class="{{(Request::segment(2) == 'blog_category') ? "text-white active":"text-dark"}} p-4 ctm-border-right"><span class="lnr lnr-book pr-0 pb-lg-2 font-23"></span><span class="">Blog</span></a>
                                    </div>
                                    <div class="col-6 align-items-center shadow-none text-center">
